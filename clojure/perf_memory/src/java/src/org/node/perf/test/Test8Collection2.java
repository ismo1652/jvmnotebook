 ...
 *
 */
public class Test8Collection2 implements Test {

    public static final void main(String [] args) {
        final Test test = new Test8Collection2();
        test.main(args, null);
    }
 ...
 */
    public final class Test1Times implements Times {
        ...
        public final void execute() {
            // slight modification, change with the value of n            
            Map m = StringUtils.frequencies(buildFrequencies(n, 3));
            m.size();
            Set d = m.keySet();                   
        }
    ...
    public void runTest() {
        ...
        System.out.println("[1] START APP -- [coll2]" + SystemUtils.memoryUsage());

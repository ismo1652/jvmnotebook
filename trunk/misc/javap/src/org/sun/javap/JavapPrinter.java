...
public class JavapPrinter {
    ...
    public int printInstr(int pc){
        ...
        switch (opcode) {
        case RuntimeConstants.opc_aload: case RuntimeConstants.opc_astore:
        case RuntimeConstants.opc_fload: case RuntimeConstants.opc_fstore:
        case RuntimeConstants.opc_iload: case RuntimeConstants.opc_istore:
        case RuntimeConstants.opc_lload: case RuntimeConstants.opc_lstore:
        case RuntimeConstants.opc_dload: case RuntimeConstants.opc_dstore:
        ...
        case RuntimeConstants.opc_newarray:
            ...
            switch (type) {
            case RuntimeConstants.T_BOOLEAN:out.print(" boolean");break;
            case RuntimeConstants.T_BYTE:   out.print(" byte");   break;
            case RuntimeConstants.T_CHAR:   out.print(" char");   break;
            case RuntimeConstants.T_SHORT:  out.print(" short");  break;
            case RuntimeConstants.T_INT:    out.print(" int");    break;
            case RuntimeConstants.T_LONG:   out.print(" long");   break;
            case RuntimeConstants.T_FLOAT:  out.print(" float");  break;
            case RuntimeConstants.T_DOUBLE: out.print(" double"); break;
            case RuntimeConstants.T_CLASS:  out.print(" class"); break;
        ...
        case RuntimeConstants.opc_ldc_w: case RuntimeConstants.opc_ldc2_w:
        case RuntimeConstants.opc_instanceof: case RuntimeConstants.opc_checkcast:
        case RuntimeConstants.opc_new:
        case RuntimeConstants.opc_putstatic: case RuntimeConstants.opc_getstatic:
        case RuntimeConstants.opc_putfield: case RuntimeConstants.opc_getfield:
        ...
        case RuntimeConstants.opc_jsr: case RuntimeConstants.opc_goto:
        case RuntimeConstants.opc_ifeq: case RuntimeConstants.opc_ifge: case RuntimeConstants.opc_ifgt:
        case RuntimeConstants.opc_ifle: case RuntimeConstants.opc_iflt: case RuntimeConstants.opc_ifne:
        case RuntimeConstants.opc_if_icmpeq: case RuntimeConstants.opc_if_icmpne: case RuntimeConstants.opc_if_icmpge:
        case RuntimeConstants.opc_if_icmpgt: case RuntimeConstants.opc_if_icmple: case RuntimeConstants.opc_if_icmplt:
        case RuntimeConstants.opc_if_acmpeq: case RuntimeConstants.opc_if_acmpne:
        case RuntimeConstants.opc_ifnull: case RuntimeConstants.opc_ifnonnull:

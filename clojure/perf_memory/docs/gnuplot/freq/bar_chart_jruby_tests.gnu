...
set xtics  ( "java8" 0.00000, "jruby8" 1.00000, "clj8" 2.00000 ) 
...
set title "Simple word/list frequency 8, java, clj, jruby" 
set xrange [ -0.500000 : 4.5000 ] noreverse nowriteback
set ylabel "Exection time in ms" 
set bmargin  3
plot 'bar_chart_jruby_tests.dat' using 0:2 title 2 with boxes,      ''          using 0:2:2 with labels center offset 0,1 notitle
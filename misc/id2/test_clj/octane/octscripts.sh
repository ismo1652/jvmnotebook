...
case "$OS" in 
	...
	*)
		...
		CP=".:src:scripts:${LIB1}:${LIB2}:${LIB3}:$LIB_CP_JFREE:$OCT_COMMONS:$CONF_LIB" ;;
esac 
...
echo "(SCRIPT): args : "  $1 $2 $3 $4
java -Xms128m -Xmx200m -classpath $CP -Doctane.install.dir="$INSTALL_DIR" \
  clojure.lang.Script $1 -- $2 $3 $4 $5 

...
public class MethodData {
    ...
    public String[] getAccess(){
        ...
        Vector v = new Vector();
        if ((access & RuntimeConstants.ACC_PUBLIC)   !=0) v.addElement("public");
        if ((access & RuntimeConstants.ACC_PRIVATE)   !=0) v.addElement("private");
        if ((access & RuntimeConstants.ACC_PROTECTED)   !=0) v.addElement("protected");
        if ((access & RuntimeConstants.ACC_STATIC)   !=0) v.addElement("static");
        if ((access & RuntimeConstants.ACC_FINAL)    !=0) v.addElement("final");
        if ((access & RuntimeConstants.ACC_SYNCHRONIZED) !=0) v.addElement("synchronized");
        if ((access & RuntimeConstants.ACC_NATIVE) !=0) v.addElement("native");
        if ((access & RuntimeConstants.ACC_ABSTRACT) !=0) v.addElement("abstract");
        if ((access & RuntimeConstants.ACC_STRICT) !=0) v.addElement("strictfp");
    ...
    public boolean isStatic(){
        if ((access & RuntimeConstants.ACC_STATIC)   !=0) return true;
        return false;
    }

...
set xtics  ( "hello1" 0.00000, "build2" 1.00000, "string3" 2.00000, "euler4" 3.00000, "euler5" 4.0, "str6" 5.0, "math7" 6.0, "coll8" 7.0, "frac9" 8.0, "sort11" 9.0, "vars12" 10.0, "wide13" 11.0 )
...
set bmargin  3
plot 'bar_chart_clj_tests.dat' using 0:2 title 2 with boxes,      ''          using 0:2:2 with labels center offset 0,1 notitle

...
## Write out script to scan for a particular filename
...
HOME_PATH = "/home/samba/samba/newspiritsync/public_html/"
...
def main():
    ...
    if z:                   
        for n in z:
            ...
            print "echo '* %s'" % filename
            print "grep -s -r -l %s ." % (filename)

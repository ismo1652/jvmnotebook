...
// Berlin Brown
//
// $Id: NeuralXORThree.java,v 1.1 2004/05/07 20:46:42 bigbinc Exp $
//
//
...
public class NeuralXORThree {
	...
	int j = 0;
        ...
        BPLayer hid1 = new BPLayer(5);
        BPLayer hid2 = new BPLayer(5);
	...
	// [ Output to learn based on input ]
        double [][] y = {
	    {  0  },  
	    {  1  },   
	    {  1  },   
